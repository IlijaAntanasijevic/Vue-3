      ...
      <div class="col-12">
        <div class="header__content">
          ...
          <ul class="header__nav">
            <li class="header__nav-item" v-for="item in navItems" :key="item">
              <router-link :to="item.path">  
                <p class="header__nav-link"> {{ item.name }}
          ...
          <div class="header__actions">
            <form action="#" class="header__form">
              ...
              <button type="button" class="header__form-close"><svg width="20" height="20" viewBox="0 0 20 20"
            ...
            <button class="header__search" type="button">
              ...
              <router-link to="singin" class="header__user">Sing In<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
